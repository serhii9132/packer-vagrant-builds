...
ubuntu-vmware: $(PYTHON)
	$(PYTHON) main.py --vmware --ubuntu
	packer init $(ARTIFACTS_DIR)/vmware/ubuntu/ubuntu.pkr.hcl
	packer build $(ARTIFACTS_DIR)/vmware/ubuntu/ubuntu.pkr.hcl

debian-vmware-rootless: $(PYTHON)
